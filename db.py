...
def insert_monitoring_record(
    site_url: str, response_time: float, http_status: int, check_datetime: str
):
    """
    ...
    conn.close()
    logging.info(
        f"Запись мониторинга добавлена для {site_url} с статусом {http_status}."
    )
