...
def send_email_notification(admin_email: str, site: str, error: str):
    ...
    if not sender_email or not sender_password:
        logging.error('Email отправителя или пароль не установлены в переменных окружения.')
        return
    ...
    try:
        ...
        server.quit()
        logging.info(f'Email-уведомление отправлено администратору о проблеме с сайтом {site}.')
